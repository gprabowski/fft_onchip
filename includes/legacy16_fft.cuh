...
template <typename CT, int Size> struct legacy16_fft {
  ...
  __device__ legacy16_fft(CT *d) : sh_d(d) {}
  ...
  static __device__ inline CT b02(const CT &a) { return a; }

  static __device__ inline CT b12(const CT &a) { return {a.imag(), -a.real()}; }

  static __device__ inline CT b04(const CT &a) { return a; }
  static __device__ inline CT b14(const CT &a) {
    return CT{SQRT_1_2 * (a.real() + a.imag()),
              SQRT_1_2 * (-a.real() + a.imag())};
  }

  static __device__ inline CT b24(const CT &a) { return {a.imag(), -a.real()}; }
  ...
  static __device__ inline CT b08(const CT &a) { return a; }

  static __device__ inline CT b18(const CT &a) { return CT{COS_8, -SIN_8} * a; }
  ...
  static __device__ inline CT b38(const CT &a) { return CT{SIN_8, -COS_8} * a; }

  static __device__ inline CT b48(const CT &a) { return {a.imag(), -a.real()}; }
  ...
  template <mul_op op> __device__ inline void dft2_twiddle(CT &a, CT &b) {
    CT tmp = op(a - b);
    a = a + b;
    b = tmp;
  }
